...
function placeXorO (squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "O") {
            ...
            disableClick();
            // This function waits 1 second beforw the computer places an image and enables click.
            setTimeout(function () {computersTurn(); }, 1000);
        }
        //Returning function results in a random square being selected by the computer.
        return true;
    }
...
function resetGame() {
    ...
    // This rests our array so it is empty and we can start over.
    selectedSquares = [];
}