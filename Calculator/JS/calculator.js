...
const Calculator = {
    //This will diaplay 0 on the calculator screen.
    Display_Value: '0',
    //This will hold the first operand for any expression, we set it to null for now.
    First_Operand: null,
    //This checks wether or not the second operand has been inputtes by the user.
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //If operator ecists, property lookup is performed for the operator
